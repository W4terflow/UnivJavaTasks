...
public class ModularDivisionOperationOption extends SavableExpressionOperationOption {
    private int value1;
    private int value2;
    ...
    public String getOptionDescription() {
        return "Деление чисел по модулю (остаток), результат сохранить в PostgreSQL с последующим выводом в консоль";
    }
