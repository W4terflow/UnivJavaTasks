...
public class SumOperationOption extends SavableExpressionOperationOption {
    private int value1;
    private int value2;
    ...
    public String getOptionDescription() {
        return "Сложение чисел, результат сохранить в PostgreSQL с последующим выводом в консоль";
    }
