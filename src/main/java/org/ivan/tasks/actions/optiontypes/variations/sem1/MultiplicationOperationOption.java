...
public class MultiplicationOperationOption extends SavableExpressionOperationOption {
    private int value1;
    private int value2;
    ...
    public String getOptionDescription() {
        return "Умножение чисел, результат сохранить в PostgreSQL с последующим выводом в консоль";
    }
