...
public class SubtractionOperationOption extends SavableExpressionOperationOption {
    private int value1;
    private int value2;
    ...
    public String getOptionDescription() {
        return "Вычитание чисел, результат сохранить в PostgreSQL с последующим выводом в консоль";
    }
